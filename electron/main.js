  ...
  const fallbackHTML = `
    ...
    <body>
      <div class="container">
        ...
        <p>Aplikacja wymaga przygotowania builda</p>
        <div class="step"><strong>1.</strong> <code>npm install</code></div>
        <div class="step"><strong>2.</strong> <code>npm run desktop:build:web</code></div>
        <div class="step"><strong>3.</strong> <code>npm run desktop:start</code></div>
        <p>✅ Tryb czysto desktopowy<br>⚡ Brak wymagań sieciowych</p>
      </div>
    </body>
    </html>
  `
